...
function addHolidays(holidaysForMonth, daysArray) {
  ...
  function createDaysArray(numberOfSquares, emptySquares, momentObj, monthIndex, toDoList) {
    let daysArray = [];
    ...
    for (let index = 0; index < numberOfSquares; index++) {
      if (index < emptySquares) {
        ...
        daysArray.push({
          ...
          date: dateOfDay,
          toDo: tasksForDate(dateString, toDoList) ? tasksForDate(dateString, toDoList) : false,
